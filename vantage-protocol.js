...
function buildDiscoveryMessages(options = {}) {
    ...
    messages.push({
        topic: `${prefix}/binary_sensor/vantage_infusion/config`,
        payload: JSON.stringify({
            name: "Vantage InFusion",
            unique_id: "vantage_infusion",
            device_class: "connectivity",
            state_topic: TOPIC_CONNECTION_STATUS,
            json_attributes_topic: TOPIC_CONNECTION_STATUS,
    ...
    for (const vid of loads) {
        messages.push({
            ...
            payload: JSON.stringify({
                ...
                json_attributes_topic: `${vid}/load/vantage/status`,
                json_attributes_template: "{{ value_json.attributes | tojson }}",
                brightness: true,
    ...
    for (const vid of blinds) {
        messages.push({
            ...
            payload: JSON.stringify({
                ...
                json_attributes_topic: `${vid}/blind/vantage/status`,
                value_template: "{{ value_json.state }}",
    ...
    for (const vid of sensors) {
        messages.push({
            ...
            payload: JSON.stringify({
                ...
                json_attributes_topic: `${vid}/sensor/vantage/status`,
                value_template: "{{ value_json.state }}",
                json_attributes_template: "{{ value_json.attributes | tojson }}",
                device: {
    ...
    for (const vid of variables) {
        messages.push({
            ...
            payload: JSON.stringify({
                ...
                json_attributes_topic: `${vid}/variable/vantage/status`,
    ...
    for (const vid of tasks) {
        messages.push({
            ...
            payload: JSON.stringify({
                ...
                json_attributes_topic: `${vid}/task/vantage/status`,
                json_attributes_template: "{{ value_json.attributes | tojson }}",
                payload_press: "BOOT",
    ...
    for (const vid of buttons) {
        messages.push({
            ...
            payload: JSON.stringify({
                ...
                json_attributes_topic: `${vid}/button/vantage/status`,
                json_attributes_template: "{{ value_json.attributes | tojson }}",
                payload_press: "PRESS",
    ...
    for (const vid of leds) {
        messages.push({
            ...
            payload: JSON.stringify({
                ...
                json_attributes_topic: `${vid}/led/vantage/status`,
                value_template: "{{ value_json.state }}",
                json_attributes_template: "{{ value_json.attributes | tojson }}",
                payload_on: "ON",
                payload_off: "OFF",
    ...
    for (const vid of therms) {
        messages.push({
            ...
            payload: JSON.stringify({
                ...
                json_attributes_topic: `${vid}/thermostat/vantage/status`,
                json_attributes_template: "{{ value_json.attributes | tojson }}",
                min_temp: 10,
                max_temp: 35,
                temp_step: 0.5,
